...
fn shift_rows(state: &mut State) {
    ...
    for col in 0..4 {
        for row in 0..4 {
            state[col][row] = old_state[(col + row) % 4][row];
        }
    }
}
...
fn inv_shift_rows(state: &mut State) {
    ...
    for col in 0..4 {
        for row in 0..4 {
            state[col][row] = old_state[(col + 4 - row) % 4][row];
        }
    }
}
...
fn mix_columns(state: &mut State) {
    ...
    for col in 0..4 {
        state[col][0] =
            MULT_2[old[col][0] as usize] ^ MULT_3[old[col][1] as usize] ^ old[col][2] ^ old[col][3];
        state[col][1] =
            old[col][0] ^ MULT_2[old[col][1] as usize] ^ MULT_3[old[col][2] as usize] ^ old[col][3];
        state[col][2] =
            old[col][0] ^ old[col][1] ^ MULT_2[old[col][2] as usize] ^ MULT_3[old[col][3] as usize];
        state[col][3] =
            MULT_3[old[col][0] as usize] ^ old[col][1] ^ old[col][2] ^ MULT_2[old[col][3] as usize];
    }
}
...
fn inv_mix_columns(state: &mut State) {
    ...
    for col in 0..4 {
        state[col][0] = MULT_E[old[col][0] as usize]
            ^ MULT_B[old[col][1] as usize]
            ^ MULT_D[old[col][2] as usize]
            ^ MULT_9[old[col][3] as usize];
        state[col][1] = MULT_9[old[col][0] as usize]
            ^ MULT_E[old[col][1] as usize]
            ^ MULT_B[old[col][2] as usize]
            ^ MULT_D[old[col][3] as usize];
        state[col][2] = MULT_D[old[col][0] as usize]
            ^ MULT_9[old[col][1] as usize]
            ^ MULT_E[old[col][2] as usize]
            ^ MULT_B[old[col][3] as usize];
        state[col][3] = MULT_B[old[col][0] as usize]
            ^ MULT_D[old[col][1] as usize]
            ^ MULT_9[old[col][2] as usize]
            ^ MULT_E[old[col][3] as usize];
    }
}
